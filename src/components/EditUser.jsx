    ...
    <>
      <div className="border bg-light  mx-auto w-50 mt-5">
        ...
        <div className="d-flex flex-column justify-content-center align-items-center">
          ...
          <div className="image">
            <Image
              src={`${data?.data?.avatar || selectUser.avatar}`}
              alt="profile"
              width={100}
              height={100}
          ...
          <div className="nameProfile mt-3 d-flex flex-column align-items-center">
            ...
            <p>
              {data?.data?.first_name || selectUser.first_name} _{" "}
              {data?.data?.last_name || selectUser.lastname}{" "}
            </p>
          </div>
          <div className="emailProfile d-flex flex-column align-items-center">
            <p className="border-0 border-bottom fw-bold"> Email User</p>
            <p>{data?.data?.email || selectUser.email}</p>
          </div>
        </div>
      </div>
      {/* update Users.............. */}
